...
window.CARDS = {
  ...
  'era-transcendental': {
    ...
    body:[
      {p:'Whitman and Thoreau first \u2014 the texts arrive in English and immediately turn into American writing. <em>Walden</em> in 1854. Thoreau did not move into a van and start streaming; he moved into a cabin on a pond and started writing, and went vegan. The story has not changed. The Enlightenment traded religion for science, science delivered the factory, and once you have watched children walk into the mill through the smoke, the pond looks very good. Eliot\u2019s <em>not with a bang but a whimper</em> is the same mood, and it has been whimpering along for a hundred and fifty years.', cite:'History of Meditation', href:'https://docs.google.com/document/d/1c8L5Xv5Bi6Dfbc2BHBIRqWL7AnCSHAOiWZC_wjK4Gq4/edit'},
